...
-->
<?php require_once "C:\\xampp\\htdocs\\Cicerone\\define.php"; ?>
<!DOCTYPE html>
<html lang="zxx">
    ...
    <div class="main-content" id="home">
        ...
        <header class="header">
            <div class="container">
                ...
                <nav class="py-3">
                    <div id="logo">
                        <h1><a class="navbar-brand" href="index.html">Cicerone</a>
                        </h1>
                    </div>
                    <label for="drop" class="toggle"><i class="fa fa-bars"></i></label>
                    <input type="checkbox" id="drop" />
                    <ul class="menu mt-2">
                        <li><a href="..\view\login.view.php">Accedi </a></li>
                        <li><a href="..\view\reg_cicerone.view.php">Registrati</a></li>                      
                    </ul>
                </nav>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row banner-grids">
                    <div class="col-lg-6 banner-info-w3ls">
                        ...
                        <h3 class="mb-3">Pianifica i tuoi itinerari con <b>CICERONE</b>!!</h3>
                    <p class="mb-4"> Sai dove alloggiare e come spostarti nella tua meta vacanze ma hai bisogno di una guida turistica low-cost che proponga mete alternative e non affollate? Unisciti a noi e scopri cosa hanno da offrire le nostre guide!</p>
                    <a href="..\view\reg_gt.view.php">Registrati</a> 
                    </div>
    ...
    <section class="about py-lg-5 py-md-5 py-5">
        <div class="container">
            <div class="inner-sec-w3pvt py-lg-5 py-3">
                <h3 class="tittle text-center mb-lg-5 mb-3 px-lg-5">Esplora il mondo con noi!</h3>
                <div class="feature-grids row mt-3 mb-lg-5 mb-3 mt-lg-5 text-center">
                    <div class="col-lg-4" data-aos="fade-up">
                        <div class="bottom-gd px-3">
                            <span class="fa fa-search" aria-hidden="true"></span>
                            <h3 class="my-4">Ricerca facilitata</h3>
                            <p>Metodo di ricerca facilitato con tante possibilità di filtraggio risultati!</p>
                        </div>
                    </div>
                    <div class="col-lg-4" data-aos="fade-up">
